...
urlpatterns = [
    ...
    path('user-delete/<int:pk>', views.Profile_Delete_View.as_view(), name='user-delete'),
    ...
    path('daily-goals/<int:user_id>', views.Daily_Goals_List_View.as_view(), name='daily-goals-list'),
]